...
requested_samples <- googlesheets4::read_sheet("https://docs.google.com/spreadsheets/d/1EEx7MrQ0Etqqmx0HNvP6We7u3MumdbKs7WQK743HxC8/edit?gid=1556500356#gid=1556500356",sheet = "metaT_requests",range = "A1:I1000") %>% 
...
(
  ...
  ggplot(aes(date_same_year, value, 
   ...
   geom_point(data = samples_for_plot,
    ...
    scale_color_manual(values = c("#46874a", "blue", "#edbb47","pink","#6c5a8f", "red", "green")) + 
